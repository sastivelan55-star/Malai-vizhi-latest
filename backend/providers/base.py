...
class HydrologyProvider(ABC):
    @abstractmethod
    def get_hydrology_data(self, lat: float, lon: float, rainfall_24h: Optional[float] = None, soil_moisture: Optional[float] = None) -> Dict[str, Any]:
        """Retrieve surface runoff index, catchment retention, and drainage metrics."""
        pass


# Explicit alias for GeocodingProvider
